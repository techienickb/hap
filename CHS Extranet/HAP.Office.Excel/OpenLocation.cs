...
namespace HAP.Office.Excel
{
    ...
    public class OpenLocation : Microsoft.Office.Core.IRibbonExtensibility
    {
        ...
        {
            return GetResourceText("HAP.Office.Excel.OpenLocation.xml");
        }
        ...
        public Bitmap GetImage(IRibbonControl control)
        {
            ...
            {
                if (string.Compare("HAP.Office.Excel.hap-logo.jpg", resourceNames[i], StringComparison.OrdinalIgnoreCase) == 0)
                {
