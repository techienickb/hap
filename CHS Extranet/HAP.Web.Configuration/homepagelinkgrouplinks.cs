...
{
    public class homepagelinkgrouplinks : ConfigurationElementCollection
    {
        ...
        public homepagelink[] FilteredLinks
        {
            get
            {
                List<homepagelink> links = new List<homepagelink>();
                foreach (homepagelink link in this)
                    if (link.ShowTo == "All" || link.ShowTo == "Inherit") links.Add(link);
