    ...
    public partial class Default : HAP.Web.Controls.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (User.IsInRole(config.AD.StudentsGroup)) { formlabel.Text = "<b>Form: </b>"; txtform.ReadOnly = true; }
                    else { formlabel.Text = "<b>Department: </b>"; txtform.ReadOnly = false; }
                }
        ...
        protected void editmydetails_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (d.Properties.Contains("department") && txtform.Text.Length > 0)
                    d.Properties["department"][0] = txtform.Text;
                else if (txtform.Text.Length > 0)
                    d.Properties["department"].Add(txtform.Text);
                d.CommitChanges();
            }
            catch {  }
            Response.Redirect("./");
