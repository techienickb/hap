...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="addres" title="Add/Edit a Resource">
        ...
        <div>
            <label for="resAdmins">Additional Admins: </label><input type="text" id="resAdmins" onclick="showadbuilder(this, false, true);" />
        </div>
        <div>
    ...
    <div id="adgroups" title="Group Builder">
        ...
        <script type="text/javascript">
            ...
            function removemapping(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'API/Setup.asmx/RemoveMapping',
                ...
                $("#qserverEditor").dialog({
                    ...
                    buttons: {
                        "Save": function () {
                            $.ajax({
                                type: 'POST',
                                url: 'API/Setup.asmx/UpdateQServer',
            ...
            function removeqserver(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'API/Setup.asmx/RemoveQServer',
                ...
                $("#addres").dialog({
                    ...
                    buttons: {
                        "Add": function () {
                            $.ajax({
                                type: 'POST',
                                url: 'API/Setup.asmx/AddResource',
                ...
                $("#addres").dialog({
                    ...
                    buttons: {
                        "Save": function () {
                            $.ajax({
                                type: 'POST',
                                url: 'API/Setup.asmx/UpdateResource',
            ...
            function removeres(b) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'API/Setup.asmx/RemoveResource',
            ...
            function removelesson(b) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'API/Setup.asmx/RemoveLesson',
                ...
                $("#addsub").dialog({
                    ...
                    buttons: {
                        "Update": function () {
                            $.ajax({
                                type: 'POST',
                                url: 'API/Setup.asmx/UpdateSubject',
            ...
            function removesubject(b) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'API/Setup.asmx/RemoveSubject',
            ...
            function removegroup(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'API/Setup.asmx/RemoveLinkGroup',
                ...
                $("#linkgroupEditor").dialog({
                    ...
                    buttons: {
                        "Update": function () {
                            $.ajax({
                                type: 'POST',
                                url: 'API/Setup.asmx/UpdateLinkGroup',
                ...
                $("#linkgroupEditor").dialog({
                    ...
                    buttons: {
                        "Update": function () {
                            $.ajax({
                                type: 'POST',
                                url: 'API/Setup.asmx/AddLinkGroup',
            ...
            $(function () {
                ...
                $(".sortablegroup").sortable({
                    ...
                    update: function (e, u) {
                        $.ajax({
                            type: 'POST',
                            url: 'API/Setup.asmx/UpdateLinkGroupOrder',
                ...
                $(".sortable").sortable({
                    ...
                    update: function (e, u) {
                        $.ajax({
                            type: 'POST',
                            url: 'API/Setup.asmx/UpdateLinkOrder',
