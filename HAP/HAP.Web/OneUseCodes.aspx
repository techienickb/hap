...
<asp:Content ContentPlaceHolderID="body" runat="server">
    <div style="padding: 10px;">
        <h1>One Use Logon Codes</h1>
        <p>One Use Codes can be used to Sign in from Untrusted locations</p>
        <p>You need to generate codes when you are at School, using a School Computer, and you will be asked to log in again</p>
    ...
    <script>$(function () { $("input[type='submit']").button(); });</script>
</asp:Content>
