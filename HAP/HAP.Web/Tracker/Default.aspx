...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
	<div id="HomeButtons" class="tiles" style="margin-left: 30%">
		<a href="live.aspx" class="tile" title="View the live action from the tracker">
		...
		<a href="logs.aspx" class="tile" title="Drill down through the Historic Logs">
		...
		<asp:HyperLink CssClass="tile" ID="dbup" runat="server" Visible="false" NavigateUrl="~/Tracker/XML2SQL.aspx" ToolTip="Upgrade from XML to a SQL Database">
			<span><i style="background-image: url(../images/icons/white/dbup.png);"></i></span>
			XML 2 SQL
		</asp:HyperLink>
		<asp:HyperLink CssClass="tile" ID="weblog" runat="server" Visible="false" NavigateUrl="~/Tracker/WebLogs.aspx" ToolTip="Web Logs">
			<span><i style="background-image: url(../images/icons/white/tracker-historic.png");"></i></span>
